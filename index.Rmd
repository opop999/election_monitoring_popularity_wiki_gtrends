...
# Specify output directory, which we also set as an environmental variable
directory <- "data/html_plots"
Sys.setenv(DIRECTORY = directory)
...
# them using bash command, with environmental variable DIRECTORY same as directory
# set at the very beginning. All non-html files in output folder are deleted.

system("find $DIRECTORY ! -name '*.html' -type f -delete")
system("find $DIRECTORY -type d -empty -delete")
