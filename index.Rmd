...
plot_total_views_gtrends <- ggplotly(
  df_total_gtrends %>%
    ...
    xlab(element_blank()) +
    ylab(element_blank()) +
    ggtitle("Cumulative intensity of Google searches since July 2015")
)
...
plot_views_yearly_gtrends <- ggplotly(
  df_per_year_gtrends %>%
    ...
    xlab(element_blank()) +
    ylab(element_blank()) +
    ggtitle("Relative per year intensity of Google searches since July 2015")
)
...
views_over_time_gtrends <- ggplotly(
  df_all_gtrends %>%
    ...
    xlab(element_blank()) +
    ylab(element_blank()) +
    ggtitle("Relative intensity of Google searches since July 2015")
)
