# PROJECT: Using Wikipedia API to measure popularity of Czech political actors
...
# searches on Seznam.cz and Google Trends, however, these platforms do not
...
extract_wikipedia <- function(article_ids, start_date, end_date, precision, dir_name) {
  ...
  # Clean the downloaded dataset, select only appropriate collumns
